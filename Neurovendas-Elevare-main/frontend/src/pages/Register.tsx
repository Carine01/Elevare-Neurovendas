      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Card className="card-glass p-10 shadow-indigo-xl rounded-2xl">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-gray-800 tracking-tight">Crie sua conta grátis</h2>
            <p className="text-gray-600 mt-2">Comece a transformar seu negócio</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <Label className="label-primary">Seu nome</Label>
              <Input
                type="text"
                value={name}
